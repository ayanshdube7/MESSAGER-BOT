...
"https://i.imgur.com/PqD8g7j.jpeg",
  ...
  var callback = () => api.sendMessage({ body: `👉❤️𝐌𝐚𝐝𝐞 𝐛𝐲 𝐌𝐫.𝐀𝐲𝐚𝐧𝐬𝐡፝֟፝֟💙✨️`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));
